...
int main(
   ...
   */
  if (verbose){
    std::cout << "Entry point label: " << p.entryPointLabel << std::endl;

    for (auto f : p.functions){
      std::cout << "Function name: " << f->name << std::endl;
      std::cout << "  # args: " << f->arguments << std::endl;
      std::cout << "  # locals: " << f->locals << std::endl;
      std::cout << "  # instructions: " << f->instructions.size() << std::endl;
    }
  }
